...
public class SLighting extends AppCompatActivity implements View.OnClickListener{
    LinearLayout lin_jy,lin_kq, lin_kqbj,lin_ding,lin_da,lin_gua,lin_don,lin_gbbg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slighting);
    ...
    private void init(){
        ...
        lin_gbbg=findViewById(R.id.lin_gbbg);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.lin_jy:
                lin_jy.setBackgroundResource(R.drawable.roundgrayb2);
                ...
                lin_gbbg.setVisibility(View.VISIBLE);
                break;
            case R.id.lin_kq:
                lin_kq.setBackgroundResource(R.drawable.roundgrayb2);
                ...
                lin_gbbg.setVisibility(View.GONE);
                break;
            case R.id.btn_next:
                startActivity(new Intent(SLighting.this, Homepage.class));
                break;
            case R.id.txt_previous:
                startActivity(new Intent(SLighting.this, Ssound.class));
                finish();
                break;
            case R.id.lin_ding:
                setSyNull();
    ...
    private void setColor(String Colour) {
        mDevice.publishDps("{\"104\":\""+Colour+"\"}", new IResultCallback() {
            @Override
